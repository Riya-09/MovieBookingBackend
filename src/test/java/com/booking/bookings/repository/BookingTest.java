...
public class BookingTest {
    ...
    public void should_return_no_violation() {
        final Booking booking = new Booking(date, show, customer, 2, BigDecimal.valueOf(244.99),"A1,A2");
    ...
    public void should_return_only_fields_required_for_booking_confirmation() {
        ...
        String seat="Z1,Z2";
        final Booking booking = new Booking(date, show, customer, 2, amountPaid,seat);
        ...
        BookingConfirmationResponse expectedBookingConfirmationResponse = new BookingConfirmationResponse(
                ...
                amountPaid,
                2,
                new ArrayList<>(Arrays.asList(seat.split(","))));
    ...
    public void should_not_allow_null_fields() {
        ...
        assertTrue(messages.containsAll(Arrays
                .asList("No of seats must be provided",
                        ...
                        "List of seats requested to be booked must be provided")));
    }

    @Test
    public void should_not_allow_no_of_seats_less_than_0() {
        final Booking booking = new Booking(date, show, customer, -1, BigDecimal.valueOf(299), "S2");
    ...
    public void should_not_allow_amount_paid_less_than_0() {
        final Booking booking = new Booking(date, show, customer, 1, BigDecimal.valueOf(-1),"S1");
