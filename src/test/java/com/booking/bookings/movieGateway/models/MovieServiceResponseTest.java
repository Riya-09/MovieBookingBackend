package test.java.com.booking.bookings.movieGateway.models;
...
class MovieServiceResponseTest {
    ...
    public void should_convert_to_a_movie_with_valid_runtime() throws FormatException {
        final var movieServiceResponse = new MovieServiceResponse("id", "title", "50 min", "plot", "7.5", "genre", "poster", "rated");

        final var actualMovie = movieServiceResponse.toMovie();

        final var expectedMovie = new Movie("id", "title", Duration.ofMinutes(50), "plot", "7.5", "genre", "poster", "rated");
    ...
    public void should_not_convert_to_a_movie_with_invalid_runtime(String runtime) {
        final var movieServiceResponse = new MovieServiceResponse("id", "title", runtime, "plot", "7.5", "genre", "poster", "rated");
