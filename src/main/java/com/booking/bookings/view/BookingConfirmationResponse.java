...
public class BookingConfirmationResponse {
    ...
    @JsonProperty
    @ApiModelProperty(name = "bookSeats", value = "List of seats booked", required = true, position = 6)
    ArrayList<String> bookSeats;

    public BookingConfirmationResponse(Long id, String customerName, Date showDate, Time startTime, BigDecimal amountPaid, int noOfSeats,ArrayList<String> bookSeats) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        return noOfSeats == that.noOfSeats &&
                ...
                Objects.equals(bookSeats, that.bookSeats);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, customerName, showDate, startTime, amountPaid, noOfSeats,bookSeats);
    }
